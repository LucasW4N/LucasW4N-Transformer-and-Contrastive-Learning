...
def params():
    ...
    # add parameter for contrastive learning
    parser.add_argument("--loss", default="SupCon", type=str,
                help="choose to use SupCon loss or SimCLR loss, put SupCon or SinCLR")
    
    parser.add_argument("--plot", default="False", type=str,
                help="put True to let Umap visualize embedding, False to not plot")
